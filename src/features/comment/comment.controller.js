...
export default class CommentController {
  ...
  async addComment(req, res) {
    try {
      ...
      const addcomment = await this.commentRepository.add(
        req.userID,
        req.params.postId,
        req.body.content
      );
  ...
  async get_Specific_Comment(req, res) {
    try {
      ...
      const getComment = await this.commentRepository.get_comment(
        req.params.postId,
        { page, limit }
      );
  ...
  async deleteComment(req, res) {
    try {
      ...
      const deletePost = await this.commentRepository.delete(
        req.userID,
  ...
  async updateComment(req, res) {
    try {
      const updatePost = await this.commentRepository.update(
        req.userID,
        req.params.commentId,
        req.body.content
      );
